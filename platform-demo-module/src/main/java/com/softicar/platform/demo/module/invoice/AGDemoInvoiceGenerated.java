...
public class AGDemoInvoiceGenerated extends AbstractDbObject<AGDemoInvoice> {
	...
	public static final IDbStringField<AGDemoInvoice> CREDITOR = BUILDER.addStringField("creditor", o->o.m_creditor, (o,v)->o.m_creditor=v).setTitle(DemoI18n.CREDITOR).setNullable().setDefault(null).setMaximumLength(255);
	public static final IDbStringField<AGDemoInvoice> DEBITOR = BUILDER.addStringField("debitor", o->o.m_debitor, (o,v)->o.m_debitor=v).setTitle(DemoI18n.DEBITOR).setNullable().setDefault(null).setMaximumLength(255);
