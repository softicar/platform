...
public class AGDemoMomentTable extends EmfObjectTable<AGDemoMoment, AGDemoInvoiceModuleInstance> {
	...
	@Override
	public void customizeEmfTableConfiguration(EmfTableConfiguration<AGDemoMoment, Integer, AGDemoInvoiceModuleInstance> configuration) {
