...
/**
 * Implement this interface if you want to handle {@link DomEventType#ENTER}.
 * <p>
 ...
 */
public interface IDomEnterKeyEventHandler extends IDomAutoEventHandler {

	void handleEnterKey(IDomEvent event);
}
