...
public class AGWorkflowNodeLog extends AbstractDbRecord<AGWorkflowNodeLog, Tuple2<AGWorkflowNode, AGTransaction>> {
	...
	public static final IDbForeignField<AGWorkflowNodeLog, AGWorkflowNode> WORKFLOW_NODE = BUILDER.addForeignField("workflowNode", o->o.m_workflowNode, (o,v)->o.m_workflowNode=v, AGWorkflowNode.ID).setTitle(WorkflowI18n.WORKFLOW_NODE);
	public static final IDbForeignField<AGWorkflowNodeLog, AGTransaction> TRANSACTION = BUILDER.addForeignField("transaction", o->o.m_transaction, (o,v)->o.m_transaction=v, AGTransaction.ID).setTitle(WorkflowI18n.TRANSACTION);
