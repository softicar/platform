...
public class AGWorkflowDemoObjectLog extends AbstractDbRecord<AGWorkflowDemoObjectLog, Tuple2<AGWorkflowDemoObject, AGTransaction>> {
	...
	public static final IDbForeignField<AGWorkflowDemoObjectLog, AGWorkflowDemoObject> WORKFLOW_DEMO_OBJECT = BUILDER.addForeignField("workflowDemoObject", o->o.m_workflowDemoObject, (o,v)->o.m_workflowDemoObject=v, AGWorkflowDemoObject.ID).setTitle(WorkflowI18n.WORKFLOW_DEMO_OBJECT);
	public static final IDbForeignField<AGWorkflowDemoObjectLog, AGTransaction> TRANSACTION = BUILDER.addForeignField("transaction", o->o.m_transaction, (o,v)->o.m_transaction=v, AGTransaction.ID).setTitle(WorkflowI18n.TRANSACTION);
	...
	public static final IDbForeignField<AGWorkflowDemoObjectLog, AGWorkflowItem> WORKFLOW_ITEM = BUILDER.addForeignField("workflowItem", o->o.m_workflowItem, (o,v)->o.m_workflowItem=v, AGWorkflowItem.ID).setTitle(WorkflowI18n.WORKFLOW_ITEM).setNullable().setDefault(null);
