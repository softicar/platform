...
public class AGWorkflowIconLog extends AbstractDbRecord<AGWorkflowIconLog, Tuple2<AGWorkflowIcon, AGTransaction>> {
	...
	public static final IDbForeignField<AGWorkflowIconLog, AGWorkflowIcon> WORKFLOW_ICON = BUILDER.addForeignField("workflowIcon", o->o.m_workflowIcon, (o,v)->o.m_workflowIcon=v, AGWorkflowIcon.ID).setTitle(WorkflowI18n.WORKFLOW_ICON);
	public static final IDbForeignField<AGWorkflowIconLog, AGTransaction> TRANSACTION = BUILDER.addForeignField("transaction", o->o.m_transaction, (o,v)->o.m_transaction=v, AGTransaction.ID).setTitle(WorkflowI18n.TRANSACTION);
	...
	public static final IDbForeignField<AGWorkflowIconLog, AGStoredFile> ICON = BUILDER.addForeignField("icon", o->o.m_icon, (o,v)->o.m_icon=v, AGStoredFile.ID).setTitle(WorkflowI18n.ICON).setNullable().setDefault(null);
