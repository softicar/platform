...
public class CsvTokenizerDfaTest extends Assert {

	private List<List<String>> tokenMatrix;

	public CsvTokenizerDfaTest() {
...
//			assertEquals("Invalid CSV format after character 4: Unexpected quote in an value.", exception.getMessage());
	...
	public void testWithNullString() {
		...
		new CsvTokenizerDfa(null).tokenize();
	}

	// ---------------- internal ---------------- //
	private void tokenize(String csv) {

		this.tokenMatrix = new CsvTokenizerDfa(csv).tokenize();
	}
