...
public class AGWorkflowNodeActionLog extends AbstractDbRecord<AGWorkflowNodeActionLog, Tuple2<AGWorkflowNodeAction, AGTransaction>> {
	...
	public static final IDbForeignField<AGWorkflowNodeActionLog, AGWorkflowNodeAction> WORKFLOW_NODE_ACTION = BUILDER.addForeignField("workflowNodeAction", o->o.m_workflowNodeAction, (o,v)->o.m_workflowNodeAction=v, AGWorkflowNodeAction.ID).setTitle(WorkflowI18n.WORKFLOW_NODE_ACTION);
	public static final IDbForeignField<AGWorkflowNodeActionLog, AGTransaction> TRANSACTION = BUILDER.addForeignField("transaction", o->o.m_transaction, (o,v)->o.m_transaction=v, AGTransaction.ID).setTitle(WorkflowI18n.TRANSACTION);
	...
	public static final IDbForeignField<AGWorkflowNodeActionLog, AGUuid> ACTION = BUILDER.addForeignField("action", o->o.m_action, (o,v)->o.m_action=v, AGUuid.ID).setTitle(WorkflowI18n.ACTION).setNullable().setDefault(null);
