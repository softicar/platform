...
public class AGWorkflowUserConfigurationLog extends AbstractDbRecord<AGWorkflowUserConfigurationLog, Tuple2<AGWorkflowUserConfiguration, AGTransaction>> {
	...
	public static final IDbForeignRowField<AGWorkflowUserConfigurationLog, AGWorkflowUserConfiguration, AGUser> WORKFLOW_USER_CONFIGURATION = BUILDER.addForeignRowField("workflowUserConfiguration", o->o.m_workflowUserConfiguration, (o,v)->o.m_workflowUserConfiguration=v, AGWorkflowUserConfiguration.USER).setTitle(WorkflowI18n.WORKFLOW_USER_CONFIGURATION).setCascade(true, true).setForeignKeyName("WorkflowUserConfigurationLog_ibfk_1");
	public static final IDbForeignField<AGWorkflowUserConfigurationLog, AGTransaction> TRANSACTION = BUILDER.addForeignField("transaction", o->o.m_transaction, (o,v)->o.m_transaction=v, AGTransaction.ID).setTitle(WorkflowI18n.TRANSACTION).setCascade(true, true).setForeignKeyName("WorkflowUserConfigurationLog_ibfk_2");
