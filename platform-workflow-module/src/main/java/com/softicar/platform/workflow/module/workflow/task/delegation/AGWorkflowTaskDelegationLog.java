...
public class AGWorkflowTaskDelegationLog extends AbstractDbRecord<AGWorkflowTaskDelegationLog, Tuple2<AGWorkflowTaskDelegation, AGTransaction>> {
	...
	public static final IDbForeignRowField<AGWorkflowTaskDelegationLog, AGWorkflowTaskDelegation, AGWorkflowTask> WORKFLOW_TASK_DELEGATION = BUILDER.addForeignRowField("workflowTaskDelegation", o->o.m_workflowTaskDelegation, (o,v)->o.m_workflowTaskDelegation=v, AGWorkflowTaskDelegation.WORKFLOW_TASK).setTitle(WorkflowI18n.WORKFLOW_TASK_DELEGATION).setCascade(true, true).setForeignKeyName("WorkflowTaskDelegationLog_ibfk_1");
	public static final IDbForeignField<AGWorkflowTaskDelegationLog, AGTransaction> TRANSACTION = BUILDER.addForeignField("transaction", o->o.m_transaction, (o,v)->o.m_transaction=v, AGTransaction.ID).setTitle(WorkflowI18n.TRANSACTION).setCascade(true, true).setForeignKeyName("WorkflowTaskDelegationLog_ibfk_2");
