...
public class AGWorkflowTransitionPermissionLog extends AbstractDbRecord<AGWorkflowTransitionPermissionLog, Tuple2<AGWorkflowTransitionPermission, AGTransaction>> {
	...
	public static final IDbForeignField<AGWorkflowTransitionPermissionLog, AGWorkflowTransitionPermission> TRANSITION_PERMISSION = BUILDER.addForeignField("transitionPermission", o->o.m_transitionPermission, (o,v)->o.m_transitionPermission=v, AGWorkflowTransitionPermission.ID).setTitle(WorkflowI18n.TRANSITION_PERMISSION);
	public static final IDbForeignField<AGWorkflowTransitionPermissionLog, AGTransaction> TRANSACTION = BUILDER.addForeignField("transaction", o->o.m_transaction, (o,v)->o.m_transaction=v, AGTransaction.ID).setTitle(WorkflowI18n.TRANSACTION);
	public static final IDbForeignField<AGWorkflowTransitionPermissionLog, AGUuid> PERMISSION = BUILDER.addForeignField("permission", o->o.m_permission, (o,v)->o.m_permission=v, AGUuid.ID).setTitle(WorkflowI18n.PERMISSION).setNullable().setDefault(null);
