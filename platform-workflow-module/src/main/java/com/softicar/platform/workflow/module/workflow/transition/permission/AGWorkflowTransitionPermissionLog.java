...
public class AGWorkflowTransitionPermissionLog extends AbstractDbRecord<AGWorkflowTransitionPermissionLog, Tuple2<AGWorkflowTransitionPermission, AGTransaction>> {
	...
	public static final IDbForeignField<AGWorkflowTransitionPermissionLog, AGWorkflowTransitionPermission> TRANSITION_PERMISSION = BUILDER.addForeignField("transitionPermission", o->o.m_transitionPermission, (o,v)->o.m_transitionPermission=v, AGWorkflowTransitionPermission.ID).setTitle(WorkflowI18n.TRANSITION_PERMISSION).setForeignKeyName("WorkflowTransitionPermissionLog_ibfk_1");
	public static final IDbForeignField<AGWorkflowTransitionPermissionLog, AGTransaction> TRANSACTION = BUILDER.addForeignField("transaction", o->o.m_transaction, (o,v)->o.m_transaction=v, AGTransaction.ID).setTitle(WorkflowI18n.TRANSACTION).setForeignKeyName("WorkflowTransitionPermissionLog_ibfk_2");
