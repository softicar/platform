...
public class AGDemoMomentGenerated extends AbstractDbObject<AGDemoMoment> {
	...
	public static final IDbForeignRowField<AGDemoMoment, AGDemoCoreModuleInstance, AGModuleInstanceBase> MODULE_INSTANCE = BUILDER.addForeignRowField("moduleInstance", o->o.m_moduleInstance, (o,v)->o.m_moduleInstance=v, AGDemoCoreModuleInstance.BASE).setTitle(DemoI18n.MODULE_INSTANCE);
