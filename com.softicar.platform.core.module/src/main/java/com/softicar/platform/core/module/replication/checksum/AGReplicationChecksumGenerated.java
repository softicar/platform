...
public class AGReplicationChecksumGenerated extends AbstractDbRecord<AGReplicationChecksum, Tuple3<String, String, Integer>> {
	...
	public static final IDbStringField<AGReplicationChecksum> LOWER_BOUNDARY = BUILDER.addStringField("lower_boundary", o->o.m_lowerBoundary, (o,v)->o.m_lowerBoundary=v).setTitle(CoreI18n.LOWER_BOUNDARY).setNullable().setLengthBits(16);
	public static final IDbStringField<AGReplicationChecksum> UPPER_BOUNDARY = BUILDER.addStringField("upper_boundary", o->o.m_upperBoundary, (o,v)->o.m_upperBoundary=v).setTitle(CoreI18n.UPPER_BOUNDARY).setNullable().setLengthBits(16);
