...
public final class Tuple7<T0, T1, T2, T3, T4, T5, T6> extends AbstractTuple {
	...
	public Tuple7(T0 e0, T1 e1, T2 e2, T3 e3, T4 e4, T5 e5, T6 e6) {
	...
	public Tuple7(Tuple6<T0, T1, T2, T3, T4, T5> tuple, T6 element) {
	...
	public <T7> Tuple8<T0, T1, T2, T3, T4, T5, T6, T7> plus(T7 element) {

		return new Tuple8<>(element0, element1, element2, element3, element4, element5, element6, element);
	}
