...
public class TestModuleBetaEntity extends AbstractEmfObject<TestModuleBetaEntity> {
	...
	public static final IDbForeignRowField<TestModuleBetaEntity, TestModuleBetaInstance, AGModuleInstanceBase> MODULE_INSTANCE = BUILDER.addForeignRowField("moduleInstance", o->o.moduleInstance, (o,v)->o.moduleInstance=v, TestModuleBetaInstance.BASE).setNullable().setDefault(null);
