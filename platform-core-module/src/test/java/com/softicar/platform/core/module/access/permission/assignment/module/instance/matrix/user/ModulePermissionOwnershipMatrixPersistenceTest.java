...
//
//		insertOrUpdateOwnershipip(moduleInstanceAlphaOne, TestStandardModuleAlphaPermissions.PERMISSION_ONE.getPermissionUuid(), userOne, true);
//
//		loadModel();
//
//		assertOriginalModelActivePermissions(getTestModuleAlpha(), instanceGroupOne, TestStandardModuleAlphaPermissions.PERMISSION_ONE);
//		assertOriginalModelNoActivePermissions(getTestModuleBeta(), instanceGroupOne);
//		assertOriginalModelNoActivePermissions(getTestModuleAlpha(), instanceGroupTwo);
//	}
//
...
//
//		insertOrUpdateOwnership(moduleInstanceAlphaOne, TestStandardModuleAlphaPermissions.PERMISSION_ONE.getPermissionUuid(), userOne, true);
//		loadModel();
//		insertOrUpdateOwnership(moduleInstanceAlphaOne, TestStandardModuleAlphaPermissions.PERMISSION_TWO.getPermissionUuid(), userOne, true);
//		loadModel();
//
//		assertOriginalModelActivePermissions(//
//			getTestModuleAlpha(),
//			instanceGroupOne,
//			TestStandardModuleAlphaPermissions.PERMISSION_ONE,
//			TestStandardModuleAlphaPermissions.PERMISSION_TWO);
//	}
//
//	@Test
//	public void testLoadWithInactivePermission() {
//
//		insertOrUpdateOwnership(moduleInstanceAlphaOne, TestStandardModuleAlphaPermissions.PERMISSION_ONE.getPermissionUuid(), userOne, false);
//		insertOrUpdateOwnership(moduleInstanceAlphaOne, TestStandardModuleAlphaPermissions.PERMISSION_TWO.getPermissionUuid(), userOne, true);
//		loadModel();
//
//		assertOriginalModelActivePermissions(//
...
//
//		insertOrUpdateOwnership(moduleInstanceAlphaTwo, TestStandardModuleAlphaPermissions.PERMISSION_ONE.getPermissionUuid(), userOne, true);
//
//		loadModel();
//
//		assertOriginalModelNoActivePermissions(getTestModuleAlpha(), instanceGroupOne);
//		assertOriginalModelNoActivePermissions(getTestModuleBeta(), instanceGroupOne);
//		assertOriginalModelActivePermissions(getTestModuleAlpha(), instanceGroupTwo, TestStandardModuleAlphaPermissions.PERMISSION_ONE);
//	}
//
//	/**
...
//
//		insertOrUpdateOwnership(moduleInstanceBetaOne, TestStandardModuleAlphaPermissions.PERMISSION_ONE.getPermissionUuid(), userOne, true);
//
//		loadModel();
//
//		assertOriginalModelNoActivePermissions(getTestModuleAlpha(), instanceGroupOne);
//		assertOriginalModelActivePermissions(getTestModuleBeta(), instanceGroupOne, TestStandardModuleAlphaPermissions.PERMISSION_ONE);
//		assertOriginalModelNoActivePermissions(getTestModuleAlpha(), instanceGroupTwo);
//	}
//
//	@Test
...
//
//		setCurrentModelValue(getTestModuleAlpha(), instanceGroupOne, TestStandardModuleAlphaPermissions.PERMISSION_ONE, true);
//
//		saveModel();
//
//		AGModulePermissionOwnership record = loadOneOwnershipRecord();
//		assertPermissionRecord(record, moduleInstanceAlphaOne, TestStandardModuleAlphaPermissions.PERMISSION_ONE, userOne, true);
//	}
//
//	@Test
...
//		loadModel();
//
//		setCurrentModelValue(getTestModuleAlpha(), instanceGroupOne, TestStandardModuleAlphaPermissions.PERMISSION_ONE, false);
//
//		saveModel();
//
//		AGModulePermissionOwnership record = loadOneOwnershipRecord();
//		assertPermissionRecord(record, moduleInstanceAlphaOne, TestStandardModuleAlphaPermissions.PERMISSION_ONE, userOne, false);
//	}
//
//	@Test
...
//		loadModel();
//
//		setCurrentModelValue(getTestModuleAlpha(), instanceGroupTwo, TestStandardModuleAlphaPermissions.PERMISSION_ONE, false);
//
//		saveModel();
//
//		assertOriginalModelActivePermissions(getTestModuleAlpha(), instanceGroupOne, TestStandardModuleAlphaPermissions.PERMISSION_ONE);
...
//		assertPermissionRecord(records.get(0), moduleInstanceAlphaOne, TestStandardModuleAlphaPermissions.PERMISSION_ONE, userOne, true);
//		assertPermissionRecord(records.get(1), moduleInstanceAlphaTwo, TestStandardModuleAlphaPermissions.PERMISSION_ONE, userOne, false);
//	}
//
//	@Test
...
//
//		insertOrUpdateOwnership(moduleInstanceAlphaOne, TestStandardModuleAlphaPermissions.PERMISSION_ONE.getPermissionUuid(), userOne, true);
//		insertOrUpdateOwnership(moduleInstanceAlphaOne, TestStandardModuleAlphaPermissions.PERMISSION_TWO.getPermissionUuid(), userOne, false);
//
//		loadModel();
//
//		setCurrentModelValue(getTestModuleAlpha(), instanceGroupOne, TestStandardModuleAlphaPermissions.PERMISSION_ONE, false);
...
//
//		List<AGModulePermissionOwnership> records = loadOwnershipRecords(2);
//		assertPermissionRecord(records.get(0), moduleInstanceAlphaOne, TestStandardModuleAlphaPermissions.PERMISSION_ONE, userOne, false);
//		assertPermissionRecord(records.get(1), moduleInstanceAlphaOne, TestStandardModuleAlphaPermissions.PERMISSION_TWO, userOne, true);
//	}
//
//	@Test
