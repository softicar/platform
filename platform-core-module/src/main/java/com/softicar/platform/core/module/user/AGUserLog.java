...
public class AGUserLog extends AbstractDbRecord<AGUserLog, Tuple2<AGUser, AGTransaction>> {
	...
	public static final IDbForeignField<AGUserLog, AGLocalizationPreset> LOCALIZATION = BUILDER.addForeignField("localization", o->o.m_localization, (o,v)->o.m_localization=v, AGLocalizationPreset.ID).setTitle(CoreI18n.LOCALIZATION).setNullable().setDefault(null);
	...
	public final AGLocalizationPreset getLocalization() {

		return getValue(LOCALIZATION);
	}

	public final AGUserLog setLocalization(AGLocalizationPreset value) {
	...
	private AGLocalizationPreset m_localization;
