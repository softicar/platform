...
public class AGStoredFileServerLog extends AbstractDbRecord<AGStoredFileServerLog, Tuple2<AGStoredFileServer, AGTransaction>> {
	...
	public static final IDbForeignField<AGStoredFileServerLog, AGStoredFileServer> STORED_FILE_SERVER = BUILDER.addForeignField("storedFileServer", o->o.m_storedFileServer, (o,v)->o.m_storedFileServer=v, AGStoredFileServer.ID).setTitle(CoreI18n.STORED_FILE_SERVER).setCascade(true, true).setForeignKeyName("StoredFileServerLog_ibfk_1");
	public static final IDbForeignField<AGStoredFileServerLog, AGTransaction> TRANSACTION = BUILDER.addForeignField("transaction", o->o.m_transaction, (o,v)->o.m_transaction=v, AGTransaction.ID).setTitle(CoreI18n.TRANSACTION).setCascade(true, true).setForeignKeyName("StoredFileServerLog_ibfk_2");
