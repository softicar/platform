...
public class AGCoreModuleInstanceGenerated extends AbstractDbObject<AGCoreModuleInstance> {
	...
	public static final IDbForeignField<AGCoreModuleInstance, AGLocalization> DEFAULT_LOCALIZATION = BUILDER.addForeignField("defaultLocalization", o->o.m_defaultLocalization, (o,v)->o.m_defaultLocalization=v, AGLocalization.ID).setTitle(CoreI18n.DEFAULT_LOCALIZATION).setNullable().setDefault(null);
