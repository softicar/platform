...
public class AGRoleUserLog extends AbstractDbRecord<AGRoleUserLog, Tuple2<AGRoleUser, AGTransaction>> {
	...
	public static final IDbForeignField<AGRoleUserLog, AGRoleUser> ROLE_USER = BUILDER.addForeignField("roleUser", o->o.m_roleUser, (o,v)->o.m_roleUser=v, AGRoleUser.ID).setTitle(CoreI18n.ROLE_USER);
	public static final IDbForeignField<AGRoleUserLog, AGTransaction> TRANSACTION = BUILDER.addForeignField("transaction", o->o.m_transaction, (o,v)->o.m_transaction=v, AGTransaction.ID).setTitle(CoreI18n.TRANSACTION);
	...
	public static final IDbForeignField<AGRoleUserLog, AGRole> ROLE = BUILDER.addForeignField("role", o->o.m_role, (o,v)->o.m_role=v, AGRole.ID).setTitle(CoreI18n.ROLE).setNullable().setDefault(null);
	public static final IDbForeignField<AGRoleUserLog, AGUser> USER = BUILDER.addForeignField("user", o->o.m_user, (o,v)->o.m_user=v, AGUser.ID).setTitle(CoreI18n.USER).setNullable().setDefault(null);
