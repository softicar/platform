...
public class AGSystemEventGenerated extends AbstractDbObject<AGSystemEvent> {
	...
	public static final IDbForeignField<AGSystemEvent, AGSystemEventSeverity> SEVERITY = BUILDER.addForeignField("severity", o->o.m_severity, (o,v)->o.m_severity=v, AGSystemEventSeverity.ID).setTitle(CoreI18n.SEVERITY).setForeignKeyName("SystemEvent_ibfk_1");
	...
	public static final IDbForeignField<AGSystemEvent, AGUser> CAUSED_BY = BUILDER.addForeignField("causedBy", o->o.m_causedBy, (o,v)->o.m_causedBy=v, AGUser.ID).setTitle(CoreI18n.CAUSED_BY).setForeignKeyName("SystemEvent_ibfk_2");
	...
	public static final IDbKey<AGSystemEvent> IK_SEVERITY = BUILDER.addIndexKey("severity", SEVERITY);
	public static final IDbKey<AGSystemEvent> IK_CAUSED_BY = BUILDER.addIndexKey("causedBy", CAUSED_BY);
