...
public class StandardModuleInstanceTable<I extends IStandardModuleInstance<I>> extends EmfSubObjectTable<I, AGModuleInstance, Integer, AGCoreModuleInstance>
	...
	public void customizeAuthorizer(EmfAuthorizer<I, AGCoreModuleInstance> authorizer) {
		...
		authorizer//
			...
			.setEditPermission(
				EmfPermissions.any(CorePermissions.ACCESS_MANAGEMENT.<I> toOtherEntityPermission(), EmfDefaultModulePermissions.getModuleAdministator()))
			.setViewPermission(
				EmfPermissions.any(CorePermissions.ACCESS_MANAGEMENT.<I> toOtherEntityPermission(), EmfDefaultModulePermissions.getModuleAdministator()));
	}
}
