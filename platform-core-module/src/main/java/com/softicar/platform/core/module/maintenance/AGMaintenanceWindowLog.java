...
public class AGMaintenanceWindowLog extends AbstractDbRecord<AGMaintenanceWindowLog, Tuple2<AGMaintenanceWindow, AGTransaction>> {
	...
	public static final IDbForeignField<AGMaintenanceWindowLog, AGMaintenanceWindow> MAINTENANCE_WINDOW = BUILDER.addForeignField("maintenanceWindow", o->o.m_maintenanceWindow, (o,v)->o.m_maintenanceWindow=v, AGMaintenanceWindow.ID).setTitle(CoreI18n.MAINTENANCE_WINDOW);
	public static final IDbForeignField<AGMaintenanceWindowLog, AGTransaction> TRANSACTION = BUILDER.addForeignField("transaction", o->o.m_transaction, (o,v)->o.m_transaction=v, AGTransaction.ID).setTitle(CoreI18n.TRANSACTION);
