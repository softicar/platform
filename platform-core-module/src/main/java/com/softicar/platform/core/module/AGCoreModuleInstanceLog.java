...
public class AGCoreModuleInstanceLog extends AbstractDbRecord<AGCoreModuleInstanceLog, Tuple2<AGCoreModuleInstance, AGTransaction>> {
	...
	public static final IDbForeignField<AGCoreModuleInstanceLog, AGTransaction> TRANSACTION = BUILDER.addForeignField("transaction", o->o.m_transaction, (o,v)->o.m_transaction=v, AGTransaction.ID).setTitle(CoreI18n.TRANSACTION).setForeignKeyName("CoreModuleInstanceLog_ibfk_2");
	...
	public static final IDbForeignField<AGCoreModuleInstanceLog, AGStoredFileServer> PRIMARY_FILE_SERVER = BUILDER.addForeignField("primaryFileServer", o->o.m_primaryFileServer, (o,v)->o.m_primaryFileServer=v, AGStoredFileServer.ID).setTitle(CoreI18n.PRIMARY_FILE_SERVER).setNullable().setDefault(null).setForeignKeyName("CoreModuleInstanceLog_ibfk_4");
