...
/**
 * A controllable cache for {@link AGModuleInstance} records.
 * <p>
 ...
 */
public class ModuleInstanceCache {

	private final ThreadSafeLazySupplier<Cache> cache;

	public ModuleInstanceCache() {
	...
	/**
	 * Determines the active {@link AGModuleInstance} for the given module
	 * {@link UUID}.
	 *
	 * @param moduleUuid
	 *            the {@link UUID} of the module which might be deployed
	 * @return the active {@link AGModuleInstance} for the given module
	 *         {@link UUID} (if any)
	 */
	public Optional<AGModuleInstance> getActive(UUID moduleUuid) {
	 ...
	 *         {@link AGUuid} (if any)
	 */
	public Optional<AGModuleInstance> getActive(AGUuid moduleUuid) {
	...
	private class Cache {
		...
		private final Map<ModuleInstanceKey, AGModuleInstance> map;
		...
		private void load() {
			...
			for (AGModuleInstance moduleInstance: AGModuleInstance.loadAllActive()) {
	...
	private class ModuleInstanceKey implements Comparable<ModuleInstanceKey> {
		...
		public ModuleInstanceKey(AGModuleInstance moduleInstance) {
