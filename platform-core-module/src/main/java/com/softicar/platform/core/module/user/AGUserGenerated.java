...
public class AGUserGenerated extends AbstractDbObject<AGUser> {
	...
	public static final IDbForeignField<AGUser, AGCoreLanguage> PREFERRED_LANGUAGE = BUILDER.addForeignField("preferredLanguage", o->o.m_preferredLanguage, (o,v)->o.m_preferredLanguage=v, AGCoreLanguage.ID).setTitle(CoreI18n.PREFERRED_LANGUAGE).setNullable().setDefault(1);
