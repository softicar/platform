...
public class AGUserGenerated extends AbstractDbObject<AGUser> {
	...
	public static final IDbForeignField<AGUser, AGLocalizationPreset> LOCALIZATION = BUILDER.addForeignField("localization", o->o.m_localization, (o,v)->o.m_localization=v, AGLocalizationPreset.ID).setTitle(CoreI18n.LOCALIZATION).setNullable().setDefault(null);
	...
	public final AGUser setLocalization(AGLocalizationPreset value) {
