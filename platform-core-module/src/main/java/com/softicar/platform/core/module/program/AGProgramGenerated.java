...
public class AGProgramGenerated extends AbstractDbObject<AGProgram> {
	...
	public static final IDbIntegerField<AGProgram> RETENTION_DAYS_OF_EXECUTIONS = BUILDER.addIntegerField("retentionDaysOfExecutions", o->o.m_retentionDaysOfExecutions, (o,v)->o.m_retentionDaysOfExecutions=v).setTitle(CoreI18n.RETENTION_DAYS_OF_EXECUTIONS).setDefault(28);
	...
	public final AGProgram setRetentionDaysOfExecutions(Integer value) {
