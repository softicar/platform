...
public interface ISqlBigDecimalExpression1<T0> extends ISqlExpression1<BigDecimal, T0>, ISqlBigDecimalExpression<ISqlBigDecimalExpression1<T0>, ISqlBooleanExpression<T0>, ISqlLongExpression1<T0>> {
	@Override
	default ISqlBigDecimalExpression1<T0> wrap(ISqlExpression<BigDecimal> expression) {
		return new SqlBigDecimalExpression1<>(expression);
	}
	...
	default <S0> ISqlBooleanExpression2<T0, S0> isEqual(ISqlExpression1<BigDecimal, S0> other) {
		return new SqlBooleanExpression2<>(SqlOperations.IS_EQUAL.create(SqlValueTypes.BOOLEAN, this, other));
	}

	default <S0> ISqlBooleanExpression2<T0, S0> isNotEqual(ISqlExpression1<BigDecimal, S0> other) {
		return new SqlBooleanExpression2<>(SqlOperations.IS_NOT_EQUAL.create(SqlValueTypes.BOOLEAN, this, other));
	}

	default <S0> ISqlBooleanExpression2<T0, S0> isLess(ISqlExpression1<BigDecimal, S0> other) {
		return new SqlBooleanExpression2<>(SqlOperations.IS_LESS.create(SqlValueTypes.BOOLEAN, this, other));
	}

	default <S0> ISqlBooleanExpression2<T0, S0> isLessEqual(ISqlExpression1<BigDecimal, S0> other) {
		return new SqlBooleanExpression2<>(SqlOperations.IS_LESS_EQUAL.create(SqlValueTypes.BOOLEAN, this, other));
	}

	default <S0> ISqlBooleanExpression2<T0, S0> isGreater(ISqlExpression1<BigDecimal, S0> other) {
		return new SqlBooleanExpression2<>(SqlOperations.IS_GREATER.create(SqlValueTypes.BOOLEAN, this, other));
	}

	default <S0> ISqlBooleanExpression2<T0, S0> isGreaterEqual(ISqlExpression1<BigDecimal, S0> other) {
		return new SqlBooleanExpression2<>(SqlOperations.IS_GREATER_EQUAL.create(SqlValueTypes.BOOLEAN, this, other));
	}

	default <S0> ISqlBigDecimalExpression2<T0, S0> plus(ISqlExpression1<BigDecimal, S0> other) {
		return new SqlBigDecimalExpression2<>(SqlOperations.PLUS.create(this, other));
	}

	default <S0> ISqlBigDecimalExpression2<T0, S0> minus(ISqlExpression1<BigDecimal, S0> other) {
		return new SqlBigDecimalExpression2<>(SqlOperations.MINUS.create(this, other));
	}

	default <S0> ISqlBigDecimalExpression2<T0, S0> times(ISqlExpression1<BigDecimal, S0> other) {
		return new SqlBigDecimalExpression2<>(SqlOperations.TIMES.create(this, other));
	}

	default <S0> ISqlBigDecimalExpression2<T0, S0> modulo(ISqlExpression1<BigDecimal, S0> other) {
		return new SqlBigDecimalExpression2<>(SqlOperations.MODULO.create(this, other));
	}

	default <S0> ISqlBigDecimalExpression2<T0, S0> divided(ISqlExpression1<BigDecimal, S0> other) {
		return new SqlBigDecimalExpression2<>(SqlOperations.DECIMAL_DIVIDED.create(this, other));
	}

	// -------------------------------- OPERATIONS 2 -------------------------------- //

	default <S0, S1> ISqlBooleanExpression3<T0, S0, S1> isEqual(ISqlExpression2<BigDecimal, S0, S1> other) {
		return new SqlBooleanExpression3<>(SqlOperations.IS_EQUAL.create(SqlValueTypes.BOOLEAN, this, other));
	}

	default <S0, S1> ISqlBooleanExpression3<T0, S0, S1> isNotEqual(ISqlExpression2<BigDecimal, S0, S1> other) {
		return new SqlBooleanExpression3<>(SqlOperations.IS_NOT_EQUAL.create(SqlValueTypes.BOOLEAN, this, other));
	}

	default <S0, S1> ISqlBooleanExpression3<T0, S0, S1> isLess(ISqlExpression2<BigDecimal, S0, S1> other) {
		return new SqlBooleanExpression3<>(SqlOperations.IS_LESS.create(SqlValueTypes.BOOLEAN, this, other));
	}

	default <S0, S1> ISqlBooleanExpression3<T0, S0, S1> isLessEqual(ISqlExpression2<BigDecimal, S0, S1> other) {
		return new SqlBooleanExpression3<>(SqlOperations.IS_LESS_EQUAL.create(SqlValueTypes.BOOLEAN, this, other));
	}

	default <S0, S1> ISqlBooleanExpression3<T0, S0, S1> isGreater(ISqlExpression2<BigDecimal, S0, S1> other) {
		return new SqlBooleanExpression3<>(SqlOperations.IS_GREATER.create(SqlValueTypes.BOOLEAN, this, other));
	}

	default <S0, S1> ISqlBooleanExpression3<T0, S0, S1> isGreaterEqual(ISqlExpression2<BigDecimal, S0, S1> other) {
		return new SqlBooleanExpression3<>(SqlOperations.IS_GREATER_EQUAL.create(SqlValueTypes.BOOLEAN, this, other));
	}

	default <S0, S1> ISqlBigDecimalExpression3<T0, S0, S1> plus(ISqlExpression2<BigDecimal, S0, S1> other) {
		return new SqlBigDecimalExpression3<>(SqlOperations.PLUS.create(this, other));
	}

	default <S0, S1> ISqlBigDecimalExpression3<T0, S0, S1> minus(ISqlExpression2<BigDecimal, S0, S1> other) {
		return new SqlBigDecimalExpression3<>(SqlOperations.MINUS.create(this, other));
	}

	default <S0, S1> ISqlBigDecimalExpression3<T0, S0, S1> times(ISqlExpression2<BigDecimal, S0, S1> other) {
		return new SqlBigDecimalExpression3<>(SqlOperations.TIMES.create(this, other));
	}

	default <S0, S1> ISqlBigDecimalExpression3<T0, S0, S1> modulo(ISqlExpression2<BigDecimal, S0, S1> other) {
		return new SqlBigDecimalExpression3<>(SqlOperations.MODULO.create(this, other));
	}

	default <S0, S1> ISqlBigDecimalExpression3<T0, S0, S1> divided(ISqlExpression2<BigDecimal, S0, S1> other) {
		return new SqlBigDecimalExpression3<>(SqlOperations.DECIMAL_DIVIDED.create(this, other));
	}

	// -------------------------------- OPERATIONS 3 -------------------------------- //

	default <S0, S1, S2> ISqlBooleanExpression4<T0, S0, S1, S2> isEqual(ISqlExpression3<BigDecimal, S0, S1, S2> other) {
		return new SqlBooleanExpression4<>(SqlOperations.IS_EQUAL.create(SqlValueTypes.BOOLEAN, this, other));
	}

	default <S0, S1, S2> ISqlBooleanExpression4<T0, S0, S1, S2> isNotEqual(ISqlExpression3<BigDecimal, S0, S1, S2> other) {
		return new SqlBooleanExpression4<>(SqlOperations.IS_NOT_EQUAL.create(SqlValueTypes.BOOLEAN, this, other));
	}

	default <S0, S1, S2> ISqlBooleanExpression4<T0, S0, S1, S2> isLess(ISqlExpression3<BigDecimal, S0, S1, S2> other) {
		return new SqlBooleanExpression4<>(SqlOperations.IS_LESS.create(SqlValueTypes.BOOLEAN, this, other));
	}

	default <S0, S1, S2> ISqlBooleanExpression4<T0, S0, S1, S2> isLessEqual(ISqlExpression3<BigDecimal, S0, S1, S2> other) {
		return new SqlBooleanExpression4<>(SqlOperations.IS_LESS_EQUAL.create(SqlValueTypes.BOOLEAN, this, other));
	}

	default <S0, S1, S2> ISqlBooleanExpression4<T0, S0, S1, S2> isGreater(ISqlExpression3<BigDecimal, S0, S1, S2> other) {
		return new SqlBooleanExpression4<>(SqlOperations.IS_GREATER.create(SqlValueTypes.BOOLEAN, this, other));
	}

	default <S0, S1, S2> ISqlBooleanExpression4<T0, S0, S1, S2> isGreaterEqual(ISqlExpression3<BigDecimal, S0, S1, S2> other) {
		return new SqlBooleanExpression4<>(SqlOperations.IS_GREATER_EQUAL.create(SqlValueTypes.BOOLEAN, this, other));
	}

	default <S0, S1, S2> ISqlBigDecimalExpression4<T0, S0, S1, S2> plus(ISqlExpression3<BigDecimal, S0, S1, S2> other) {
		return new SqlBigDecimalExpression4<>(SqlOperations.PLUS.create(this, other));
	}

	default <S0, S1, S2> ISqlBigDecimalExpression4<T0, S0, S1, S2> minus(ISqlExpression3<BigDecimal, S0, S1, S2> other) {
		return new SqlBigDecimalExpression4<>(SqlOperations.MINUS.create(this, other));
	}

	default <S0, S1, S2> ISqlBigDecimalExpression4<T0, S0, S1, S2> times(ISqlExpression3<BigDecimal, S0, S1, S2> other) {
		return new SqlBigDecimalExpression4<>(SqlOperations.TIMES.create(this, other));
	}

	default <S0, S1, S2> ISqlBigDecimalExpression4<T0, S0, S1, S2> modulo(ISqlExpression3<BigDecimal, S0, S1, S2> other) {
		return new SqlBigDecimalExpression4<>(SqlOperations.MODULO.create(this, other));
	}

	default <S0, S1, S2> ISqlBigDecimalExpression4<T0, S0, S1, S2> divided(ISqlExpression3<BigDecimal, S0, S1, S2> other) {
