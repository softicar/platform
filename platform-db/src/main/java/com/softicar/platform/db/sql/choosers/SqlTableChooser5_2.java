...
public final class SqlTableChooser5_2<V, S extends ISqlSelectCoreAdapter, T0, T1, T2, T3, T4, E0, E1> extends AbstractSqlTableChooser<S> {
	...
	public SqlTableChooser5_3<V, S, T0, T1, T2, T3, T4, E0, E1, T0> t0() {

		return new SqlTableChooser5_3<>(this, 0);
	}

	public SqlTableChooser5_3<V, S, T0, T1, T2, T3, T4, E0, E1, T1> t1() {

		return new SqlTableChooser5_3<>(this, 1);
	}

	public SqlTableChooser5_3<V, S, T0, T1, T2, T3, T4, E0, E1, T2> t2() {

		return new SqlTableChooser5_3<>(this, 2);
	}

	public SqlTableChooser5_3<V, S, T0, T1, T2, T3, T4, E0, E1, T3> t3() {

		return new SqlTableChooser5_3<>(this, 3);
	}

	public SqlTableChooser5_3<V, S, T0, T1, T2, T3, T4, E0, E1, T4> t4() {

		return new SqlTableChooser5_3<>(this, 4);
	}

	SqlTableChooser5_2(AbstractSqlTableChooser<S> chooser, int tableIndex) {
