...
public class DbEnumTableRowStructureCompatibilityComparer extends AbstractDbEnumTableRowStructureComparer {

	public DbEnumTableRowStructureCompatibilityComparer(IDbTableStructureComparerConfiguration configuration) {
	...
	protected void checkReferenceExclusiveFeature(DbExclusiveFeatureChecker<IDbEnumTableRowStructure> checker) {
		...
		checker//
			.addWarningIf(Predicates.always(), "Surplus enum table row in %s.", getReferenceName());
	}
