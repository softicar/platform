...
public final class SqlSelect6_4<T0, T1, T2, T3, T4, T5, V0, V1, V2, V3> extends SqlSelectBase4<V0, V1, V2, V3> implements ISqlSelectLastTableExtension<SqlSelect6_4<T0, T1, T2, T3, T4, T5, V0, V1, V2, V3>, T5> {
	...
	public <T6> SqlSelect7_4<T0, T1, T2, T3, T4, T5, T6, V0, V1, V2, V3> join(ISqlTable<T6> table) {
		...
		return _join(new SqlSelect7_4<>(other, expression), table, JoinType.JOIN);
	}
	...
	public <T6> SqlSelect7_4<T0, T1, T2, T3, T4, T5, T6, V0, V1, V2, V3> joinLeft(ISqlTable<T6> table) {
		...
		return _join(new SqlSelect7_4<>(other, expression), table, JoinType.LEFT_JOIN);
	}
	...
	public final class SelectChooser0 extends SelectChooserBase {
		...
		<V> SqlSelect6_5<T0, T1, T2, T3, T4, T5, V0, V1, V2, V3, V> x(ISqlExpression0<V> expression) { return addExpression(new SqlSelect6_5<>(SqlSelect6_4.this, expression), expression); }
	...
	public final class SelectChooser1<E0> extends SelectChooserBase {
		...
		<V> SqlSelect6_5<T0, T1, T2, T3, T4, T5, V0, V1, V2, V3, V> x(ISqlExpression1<V, E0> expression) { return addExpression(new SqlSelect6_5<>(SqlSelect6_4.this, expression), expression); }
	...
	public final class SelectChooser2<E0, E1> extends SelectChooserBase {
		...
		<V> SqlSelect6_5<T0, T1, T2, T3, T4, T5, V0, V1, V2, V3, V> x(ISqlExpression2<V, E0, E1> expression) { return addExpression(new SqlSelect6_5<>(SqlSelect6_4.this, expression), expression); }
	...
	public final class SelectChooser3<E0, E1, E2> extends SelectChooserBase {
		...
		<V> SqlSelect6_5<T0, T1, T2, T3, T4, T5, V0, V1, V2, V3, V> x(ISqlExpression3<V, E0, E1, E2> expression) { return addExpression(new SqlSelect6_5<>(SqlSelect6_4.this, expression), expression); }
	...
	public final class SelectChooser4<E0, E1, E2, E3> extends SelectChooserBase {
		...
		<V> SqlSelect6_5<T0, T1, T2, T3, T4, T5, V0, V1, V2, V3, V> x(ISqlExpression4<V, E0, E1, E2, E3> expression) { return addExpression(new SqlSelect6_5<>(SqlSelect6_4.this, expression), expression); }
