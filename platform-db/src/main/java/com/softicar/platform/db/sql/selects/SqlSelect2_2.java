...
public final class SqlSelect2_2<T0, T1, V0, V1> extends SqlSelectBase2<V0, V1> implements ISqlSelectLastTableExtension<SqlSelect2_2<T0, T1, V0, V1>, T1> {
	...
	public <T2> SqlSelect3_2<T0, T1, T2, V0, V1> join(ISqlTable<T2> table) {
		...
		return _join(new SqlSelect3_2<>(other, expression), table, JoinType.JOIN);
	}
	...
	public <T2> SqlSelect3_2<T0, T1, T2, V0, V1> joinLeft(ISqlTable<T2> table) {
		...
		return _join(new SqlSelect3_2<>(other, expression), table, JoinType.LEFT_JOIN);
	}
	...
	public final class SelectChooser0 extends SelectChooserBase {
		...
		<V> SqlSelect2_3<T0, T1, V0, V1, V> x(ISqlExpression0<V> expression) { return addExpression(new SqlSelect2_3<>(SqlSelect2_2.this, expression), expression); }
	...
	public final class SelectChooser1<E0> extends SelectChooserBase {
		...
		<V> SqlSelect2_3<T0, T1, V0, V1, V> x(ISqlExpression1<V, E0> expression) { return addExpression(new SqlSelect2_3<>(SqlSelect2_2.this, expression), expression); }
	...
	public final class SelectChooser2<E0, E1> extends SelectChooserBase {
		...
		<V> SqlSelect2_3<T0, T1, V0, V1, V> x(ISqlExpression2<V, E0, E1> expression) { return addExpression(new SqlSelect2_3<>(SqlSelect2_2.this, expression), expression); }
	...
	public final class SelectChooser3<E0, E1, E2> extends SelectChooserBase {
		...
		<V> SqlSelect2_3<T0, T1, V0, V1, V> x(ISqlExpression3<V, E0, E1, E2> expression) { return addExpression(new SqlSelect2_3<>(SqlSelect2_2.this, expression), expression); }
	...
	public final class SelectChooser4<E0, E1, E2, E3> extends SelectChooserBase {
		...
		<V> SqlSelect2_3<T0, T1, V0, V1, V> x(ISqlExpression4<V, E0, E1, E2, E3> expression) { return addExpression(new SqlSelect2_3<>(SqlSelect2_2.this, expression), expression); }
