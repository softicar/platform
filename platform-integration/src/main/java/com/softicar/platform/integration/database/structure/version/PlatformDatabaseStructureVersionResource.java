...
public interface PlatformDatabaseStructureVersionResource {
	...
	IResourceSupplier V40_MIGRATION = FACTORY.create("v40-migration.sql");
	IResourceSupplier V40_STRUCTURE = FACTORY.create("v40-structure.json");
	IResourceSupplier V41_MIGRATION = FACTORY.create("v41-migration.sql");
	IResourceSupplier V41_STRUCTURE = FACTORY.create("v41-structure.json");
	IResourceSupplier V43_MIGRATION = FACTORY.create("v43-migration.sql");
	IResourceSupplier V43_STRUCTURE = FACTORY.create("v43-structure.json");
	IResourceSupplier V44_MIGRATION = FACTORY.create("v44-migration.sql");
	IResourceSupplier V44_STRUCTURE = FACTORY.create("v44-structure.json");
	IResourceSupplier V45_MIGRATION = FACTORY.create("v45-migration.sql");
	IResourceSupplier V45_STRUCTURE = FACTORY.create("v45-structure.json");
	IResourceSupplier V46_MIGRATION = FACTORY.create("v46-migration.sql");
	IResourceSupplier V46_STRUCTURE = FACTORY.create("v46-structure.json");
	IResourceSupplier V47_MIGRATION = FACTORY.create("v47-migration.sql");
	IResourceSupplier V47_STRUCTURE = FACTORY.create("v47-structure.json");
	IResourceSupplier V50_MIGRATION = FACTORY.create("v50-migration.sql");
	IResourceSupplier V50_STRUCTURE = FACTORY.create("v50-structure.json");
	IResourceSupplier V51_MIGRATION = FACTORY.create("v51-migration.sql");
	IResourceSupplier V51_STRUCTURE = FACTORY.create("v51-structure.json");
}
