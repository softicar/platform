...
public final class SqlTableChooser6_3<V, S extends ISqlSelectCoreAdapter, T0, T1, T2, T3, T4, T5, E0, E1, E2> extends AbstractSqlTableChooser<S> {
	...
	SqlTableChooser6_3(AbstractSqlTableChooser<S> chooser, int tableIndex) {
