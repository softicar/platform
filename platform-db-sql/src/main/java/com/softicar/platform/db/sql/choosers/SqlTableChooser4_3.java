...
public final class SqlTableChooser4_3<V, S extends ISqlSelectCoreAdapter, T0, T1, T2, T3, E0, E1, E2> extends AbstractSqlTableChooser<S> {
	...
	SqlTableChooser4_3(AbstractSqlTableChooser<S> chooser, int tableIndex) {
