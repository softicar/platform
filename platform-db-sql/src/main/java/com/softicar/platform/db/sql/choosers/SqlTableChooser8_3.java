...
public final class SqlTableChooser8_3<V, S extends ISqlSelectCoreAdapter, T0, T1, T2, T3, T4, T5, T6, T7, E0, E1, E2> extends AbstractSqlTableChooser<S> {
	...
	public S t7(ISqlExpression4<? extends V, E0, E1, E2, T7> expression) {

		return addTable(7).addExpression(expression);
	}

	SqlTableChooser8_3(AbstractSqlTableChooser<S> chooser, int tableIndex) {
