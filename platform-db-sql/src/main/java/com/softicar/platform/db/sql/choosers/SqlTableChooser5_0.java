...
public final class SqlTableChooser5_0<V, S extends ISqlSelectCoreAdapter, T0, T1, T2, T3, T4> extends AbstractSqlTableChooser<S> {
	...
	public SqlTableChooser5_1<V, S, T0, T1, T2, T3, T4, T0> t0() {

		return new SqlTableChooser5_1<>(this, 0);
	}

	public SqlTableChooser5_1<V, S, T0, T1, T2, T3, T4, T1> t1() {

		return new SqlTableChooser5_1<>(this, 1);
	}

	public SqlTableChooser5_1<V, S, T0, T1, T2, T3, T4, T2> t2() {

		return new SqlTableChooser5_1<>(this, 2);
	}

	public SqlTableChooser5_1<V, S, T0, T1, T2, T3, T4, T3> t3() {

		return new SqlTableChooser5_1<>(this, 3);
	}

	public SqlTableChooser5_1<V, S, T0, T1, T2, T3, T4, T4> t4() {

		return new SqlTableChooser5_1<>(this, 4);
	}

	public SqlTableChooser5_0(S select, PartType partType) {
