...
public final class SqlTableChooser6_1<V, S extends ISqlSelectCoreAdapter, T0, T1, T2, T3, T4, T5, E0> extends AbstractSqlTableChooser<S> {
	...
	public SqlTableChooser6_2<V, S, T0, T1, T2, T3, T4, T5, E0, T0> t0() {

		return new SqlTableChooser6_2<>(this, 0);
	}

	public SqlTableChooser6_2<V, S, T0, T1, T2, T3, T4, T5, E0, T1> t1() {

		return new SqlTableChooser6_2<>(this, 1);
	}

	public SqlTableChooser6_2<V, S, T0, T1, T2, T3, T4, T5, E0, T2> t2() {

		return new SqlTableChooser6_2<>(this, 2);
	}

	public SqlTableChooser6_2<V, S, T0, T1, T2, T3, T4, T5, E0, T3> t3() {

		return new SqlTableChooser6_2<>(this, 3);
	}

	public SqlTableChooser6_2<V, S, T0, T1, T2, T3, T4, T5, E0, T4> t4() {

		return new SqlTableChooser6_2<>(this, 4);
	}

	public SqlTableChooser6_2<V, S, T0, T1, T2, T3, T4, T5, E0, T5> t5() {

		return new SqlTableChooser6_2<>(this, 5);
	}

	SqlTableChooser6_1(AbstractSqlTableChooser<S> chooser, int tableIndex) {
