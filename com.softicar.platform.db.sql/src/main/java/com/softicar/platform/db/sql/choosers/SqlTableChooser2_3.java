...
public final class SqlTableChooser2_3<V, S extends ISqlSelectCoreAdapter, T0, T1, E0, E1, E2> extends AbstractSqlTableChooser<S> {
	...
	SqlTableChooser2_3(AbstractSqlTableChooser<S> chooser, int tableIndex) {
