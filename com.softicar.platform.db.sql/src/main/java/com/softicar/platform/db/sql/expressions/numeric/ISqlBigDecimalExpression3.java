...
public interface ISqlBigDecimalExpression3<T0, T1, T2> extends ISqlExpression3<BigDecimal, T0, T1, T2>, ISqlBigDecimalExpression<ISqlBigDecimalExpression3<T0, T1, T2>, ISqlBooleanExpression3<T0, T1, T2>, ISqlLongExpression3<T0, T1, T2>> {
	@Override
	default ISqlBigDecimalExpression3<T0, T1, T2> wrap(ISqlExpression<BigDecimal> expression) {
		return new SqlBigDecimalExpression3<>(expression);
	}
	...
	default <S0> ISqlBooleanExpression4<T0, T1, T2, S0> isEqual(ISqlExpression1<BigDecimal, S0> other) {
		return new SqlBooleanExpression4<>(SqlOperations.IS_EQUAL.create(SqlValueTypes.BOOLEAN, this, other));
	}

	default <S0> ISqlBooleanExpression4<T0, T1, T2, S0> isNotEqual(ISqlExpression1<BigDecimal, S0> other) {
		return new SqlBooleanExpression4<>(SqlOperations.IS_NOT_EQUAL.create(SqlValueTypes.BOOLEAN, this, other));
	}

	default <S0> ISqlBooleanExpression4<T0, T1, T2, S0> isLess(ISqlExpression1<BigDecimal, S0> other) {
		return new SqlBooleanExpression4<>(SqlOperations.IS_LESS.create(SqlValueTypes.BOOLEAN, this, other));
	}

	default <S0> ISqlBooleanExpression4<T0, T1, T2, S0> isLessEqual(ISqlExpression1<BigDecimal, S0> other) {
		return new SqlBooleanExpression4<>(SqlOperations.IS_LESS_EQUAL.create(SqlValueTypes.BOOLEAN, this, other));
	}

	default <S0> ISqlBooleanExpression4<T0, T1, T2, S0> isGreater(ISqlExpression1<BigDecimal, S0> other) {
		return new SqlBooleanExpression4<>(SqlOperations.IS_GREATER.create(SqlValueTypes.BOOLEAN, this, other));
	}

	default <S0> ISqlBooleanExpression4<T0, T1, T2, S0> isGreaterEqual(ISqlExpression1<BigDecimal, S0> other) {
		return new SqlBooleanExpression4<>(SqlOperations.IS_GREATER_EQUAL.create(SqlValueTypes.BOOLEAN, this, other));
	}

	default <S0> ISqlBigDecimalExpression4<T0, T1, T2, S0> plus(ISqlExpression1<BigDecimal, S0> other) {
		return new SqlBigDecimalExpression4<>(SqlOperations.PLUS.create(this, other));
	}

	default <S0> ISqlBigDecimalExpression4<T0, T1, T2, S0> minus(ISqlExpression1<BigDecimal, S0> other) {
		return new SqlBigDecimalExpression4<>(SqlOperations.MINUS.create(this, other));
	}

	default <S0> ISqlBigDecimalExpression4<T0, T1, T2, S0> times(ISqlExpression1<BigDecimal, S0> other) {
		return new SqlBigDecimalExpression4<>(SqlOperations.TIMES.create(this, other));
	}

	default <S0> ISqlBigDecimalExpression4<T0, T1, T2, S0> modulo(ISqlExpression1<BigDecimal, S0> other) {
		return new SqlBigDecimalExpression4<>(SqlOperations.MODULO.create(this, other));
	}

	default <S0> ISqlBigDecimalExpression4<T0, T1, T2, S0> divided(ISqlExpression1<BigDecimal, S0> other) {
