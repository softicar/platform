...
public final class SqlTableChooser6_2<V, S extends ISqlSelectCoreAdapter, T0, T1, T2, T3, T4, T5, E0, E1> extends AbstractSqlTableChooser<S> {
	...
	public SqlTableChooser6_3<V, S, T0, T1, T2, T3, T4, T5, E0, E1, T0> t0() {

		return new SqlTableChooser6_3<>(this, 0);
	}

	public SqlTableChooser6_3<V, S, T0, T1, T2, T3, T4, T5, E0, E1, T1> t1() {

		return new SqlTableChooser6_3<>(this, 1);
	}

	public SqlTableChooser6_3<V, S, T0, T1, T2, T3, T4, T5, E0, E1, T2> t2() {

		return new SqlTableChooser6_3<>(this, 2);
	}

	public SqlTableChooser6_3<V, S, T0, T1, T2, T3, T4, T5, E0, E1, T3> t3() {

		return new SqlTableChooser6_3<>(this, 3);
	}

	public SqlTableChooser6_3<V, S, T0, T1, T2, T3, T4, T5, E0, E1, T4> t4() {

		return new SqlTableChooser6_3<>(this, 4);
	}

	public SqlTableChooser6_3<V, S, T0, T1, T2, T3, T4, T5, E0, E1, T5> t5() {

		return new SqlTableChooser6_3<>(this, 5);
	}

	SqlTableChooser6_2(AbstractSqlTableChooser<S> chooser, int tableIndex) {
