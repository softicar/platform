...
public class EmfDeleteHookWrapperTest extends AbstractDbTest {
	...
	public EmfDeleteHookWrapperTest() {
	...
	public void testSingleScope() {
		...
		var wrapper = new EmfDeleteHookWrapper<>(this::createHookInstance);

		wrapper.beforeDelete(dummyTableRowCollection);
		wrapper.afterDelete(dummyTableRowCollection);
		wrapper.beforeDelete(dummyTableRowCollection);
		wrapper.afterDelete(dummyTableRowCollection);
	...
	private class TestHook implements IEmfDeleteHook<EmfTestObject> {
		...
		@Override
		public void beforeDelete(Collection<EmfTestObject> tableRows) {
		...
		@Override
		public void afterDelete(Collection<EmfTestObject> tableRows) {
