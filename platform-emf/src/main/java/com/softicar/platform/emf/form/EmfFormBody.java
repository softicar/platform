...
class EmfFormBody<R extends IEmfTableRow<R, ?>> extends DomDiv implements IEmfFormBody<R> {
	...
	public EmfFormBody(EmfForm<R> form, IEmfFormAttributesDivConfiguration<R> attributesDivConfiguration) {

		this.form = form;
		this.tableRow = form.getTableRow();
		this.upperPart = new EmfFormBodyUpperPart<>(this, attributesDivConfiguration);
