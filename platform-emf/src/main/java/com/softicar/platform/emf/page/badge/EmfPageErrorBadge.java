...
/**
 * An {@link EmfPageBadge} with {@link EmfDiagnosticLevel#ERROR}.
 *
 * @author Oliver Richers
 */
public class EmfPageErrorBadge extends EmfPageBadge {
	 ...
	 */
	public EmfPageErrorBadge(Supplier<Integer> countSupplier) {

		super(EmfDiagnosticLevel.ERROR, countSupplier);
	}
}
