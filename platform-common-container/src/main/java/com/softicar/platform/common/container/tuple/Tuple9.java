...
public final class Tuple9<T0, T1, T2, T3, T4, T5, T6, T7, T8> extends AbstractTuple {
	...
	public Tuple9(T0 e0, T1 e1, T2 e2, T3 e3, T4 e4, T5 e5, T6 e6, T7 e7, T8 e8) {
	...
	public Tuple9(Tuple8<T0, T1, T2, T3, T4, T5, T6, T7> tuple, T8 element) {
	...
	public <T9> Tuple10<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9> plus(T9 element) {

		return new Tuple10<>(element0, element1, element2, element3, element4, element5, element6, element7, element8, element);
	}
